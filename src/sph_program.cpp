...
void ComputeShaderApplication::createInstance() {
  ...
  appInfo.pApplicationName = "Simple SPH";
...
void ComputeShaderApplication::populateDebugMessengerCreateInfo(
...
void ComputeShaderApplication::createGraphicsPipeline() {
  auto vertShaderCode = readFile("shaders/shader_compute.vert.spv");
  auto fragShaderCode = readFile("shaders/shader_compute.frag.spv");
...
void ComputeShaderApplication::createComputePipeline() {
  auto computeShaderCode = readFile("shaders/shader_compute.comp.spv");
...
void ComputeShaderApplication::createBuffer(VkDeviceSize size,
...
void ComputeShaderApplication::copyBuffer(VkBuffer srcBuffer,
                                          VkBuffer dstBuffer,
                                          VkDeviceSize size) {
...
uint32_t
ComputeShaderApplication::findMemoryType(uint32_t typeFilter,
                                         VkMemoryPropertyFlags properties) {
...
void ComputeShaderApplication::recordCommandBuffer(
...
void ComputeShaderApplication::recordComputeCommandBuffer(
    VkCommandBuffer commandBuffer) {
  VkCommandBufferBeginInfo beginInfo{};
  beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
...
VkShaderModule
ComputeShaderApplication::createShaderModule(const std::vector<char> &code) {
...
VkExtent2D ComputeShaderApplication::chooseSwapExtent(
...
ComputeShaderApplication::querySwapChainSupport(VkPhysicalDevice device) {
...
bool ComputeShaderApplication::checkDeviceExtensionSupport(
...
QueueFamilyIndices
ComputeShaderApplication::findQueueFamilies(VkPhysicalDevice device) {
